module.exports = {
	...
	adminId: "462346519568187393", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "OTc1ODExODEyMzg3ODQ4MzA0.GXSm7u.vn0uS65t4rew0UcsaoVsxO_iDjrl3IChGiClrE", //- Bot's Token
	clientId: process.env.clientId || "975811812387848304", //- ID of the bot
	clientSecret: process.env.clientSecret || "bJ8s_cQB6zLBxkDZlCzxsePsLbIxz0tj", //- Client Secret of the bot
